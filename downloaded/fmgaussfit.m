...
% compute 2D gaussian
% % % AM: par(7) = intercept
% % % par(1) = A = amplitude = peak of z
% % % par(5) = x0, par(6) = y0..... coordinates of z peak see http://en.wikipedia.org/wiki/Gaussian_function#Two-dimensional_Gaussian_function
% % % par(2) = theta.... rotation of 2d Gaussian in degrees
% % % par(3) = sqrt(2)*sigma_x
% % % par(4) = sqrt(2)*sigma_y
z = par(7) + ...    ### in wiki article, see 'Meaning of parameters for the general equation' - expand the quadratics below to find a, b, c in wiki article
