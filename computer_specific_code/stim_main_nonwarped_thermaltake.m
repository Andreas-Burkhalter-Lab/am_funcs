...
stimpars.diam_minmax = [13 150]; %% range of annulus diameters in degrees ([1 64] in Gao fig 1)
stimpars.orient_range = [0 360]; % range of linearly-space angles to present, not including@ the upper limit
stimpars.n_sfs = 0;      % number of values of annulus spatial frequency to present; if zero, don't test this param
stimpars.n_tfs = 1;      % number of values of annulus temporal frequency to present; if zero, don't test this param
stimpars.n_orients = 0; %% number of values of annulus orientations to present; if zero, don't test this param
stimpars.n_diams = 4;   % number of values of annulus diameter to present
