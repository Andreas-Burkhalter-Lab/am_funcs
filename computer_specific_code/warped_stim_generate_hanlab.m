function [  ] = warped_stim_generate_hanlab(  )
...
prerend.n_sfs = 7;      % number of values of annulus spatial frequency to present
prerend.n_tfs = 7;      % number of values of annulus temporal frequency to present
prerend.n_orients = 8; 
