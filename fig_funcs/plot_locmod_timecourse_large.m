% this version creates an image to be used as a large subfigure, rather than a small inset figure
...
pars.timecourse_line_width = 4; %%%% line for response timecourse
pars.ebar_linewidth = 1.5; 
pars.ebar_cap_size = 3; % errorbar cap length
pars.axes_line_width = 4;
pars.axes_numbers_bold = 'bold'; %%% 'bold' or 'normal'
pars.axis_font_size = 18;
pars.font_name = 'Arial'; 
pars.fig_outerposition = [0 0 0.005 0]; % [left bottom width height]
pars.show_legend = 0; 
...
set(gca,'LooseInset',get(gca,'TightInset')+pars.fig_outerposition) % crop borders
