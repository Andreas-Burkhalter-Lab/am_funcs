...
OPTIONS = optimset('Display','off','MaxIter',5000); %% AM 10/2/15 replaced above two lines with this line as per Aki's instructions
...
for j=1:N_reps
    ...
    err(j) = von_mises_error(testpars{j}); %%%% formerly used hyperpolicratio_error, probably a typo
end
%err
