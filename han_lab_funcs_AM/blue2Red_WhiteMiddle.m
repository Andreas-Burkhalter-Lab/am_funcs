function newmap = blue2Red_WhiteMiddle(cmin_input,cmax_input, numberOfSteps)
...
%  Modified NML
%  2014-06-20
%  now accepts arbitrary number of steps (forces odd number of steps)
%   Examples:
%   ------------------------------
%   figure
%   peaks;
...
if nargin <3
numberOfSteps = 250; %default number of steps = 250
%      disp('using 250 steps for colormap');
end
...
if mod(numberOfSteps,2)==1
    % force even number of steps
