...
title('Dist vs correlation')
xlabel('Distance')
ylabel('Correlation')


        saveas(gca,[saveDir,'\', 'Dist vs correlation',' All Cells',name,'.jpg']);
        savefig([saveDir,'\', 'Dist vs correlation', ' All Cells ',name,'.fig']);
        
        figure
        histogram(corrsall,101);
