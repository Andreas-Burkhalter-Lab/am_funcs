...
% if numframes>10000
%     badframes=[1:round(numframes/4),(round(numframes/4)+5001):numframes];
% else
% badframes=[];
% end
badframes=[];
...
[mixedsig, mixedfilters, CovEvals, covtrace, movm, movtm] = CellsortPCA_MA_chonecorr([inputdir,fn], flims, nPCs, dsamp, inputdir, badframes,sizeMov);
...
cell_sig = CellsortApplyFilter_new_MA_chonecorr([inputdir,fn], ica_segments, flims, f0, subtractmean,sizeMov);
