function code = bigSquareArenaTargetChase
% bigSquareArenaTargetChase   Code for the ViRMEn experiment bigSquareArenaTargetChase.
%   code = bigSquareArenaTargetChase   Returns handles to the functions that ViRMEn
