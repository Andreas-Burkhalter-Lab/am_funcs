function code = Track_180cm_eh_test1_2Xrew_world_switchForGain
%switches forward gain in new world
...
vr.gainFactor=0.5;%for changing forward gain
...
if vr.currentGain == 2
    vr.dp(2) = vr.dp(2)*vr.gainFactor; % multiply forward gain by vr.gainFactor
end
