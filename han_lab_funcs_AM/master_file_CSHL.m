...
db(1).mouse_name    = 'S22';
db(1).date          = '2017-03-30';
db(1).expts         = 1;
db(1).diameter      = 10;

ops0.toolbox_path = 'C:\Users\Han lab\Documents\MATLAB\MA scripts\Suite2P-master';
...
ops0.RootStorage            = 'G:\CPP\'; % Suite2P assumes a folder structure, check out README file
...
ops0.ResultsSavePath        = 'G:\CPP\'; % a folder structure is created inside
...
ops0.imageRate              = 2.5;   % imaging rate (cumulative over planes!). Approximate, for initialization of deconvolution kernel.
