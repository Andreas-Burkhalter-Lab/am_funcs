...
% for f=1:num_files
%     loadVideo(paths{f},files{f},num_planes(f));
% end
...
for i=1:num_files
    ...
    %To use hmm
    systemCommand = ['python C:/Users/han/Documents/Python_Scripts/simahmm.py ', file, ' ', num2str(4)];
...
%     
%     systemCommand = ['python C:/Users/han/Documents/Python_Scripts/simalin.py ', file, ' ', num2str(4)];
%     system(systemCommand)
%     %Reads in hdf5 file format from python code and converts it back into
%     %mat files
%     for p=1:num_planes(i)
