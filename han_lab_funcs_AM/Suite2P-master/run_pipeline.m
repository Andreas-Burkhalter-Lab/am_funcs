...
%%%% edited by AM 2020/1/21 to reduce NimgFirstRegistration if it's greater than or equal to number of frames in image stack
...
ops.NimgFirstRegistration = min([ops.NimgFirstRegistration, nframes_in_stack-1]); % reduce NimgFirstRegistration if necessary
%%%%
