...
db(1).mouse_name    = 'M170604_MP031';
db(1).date          = '2017-07-01';
db(1).expts         = 4;
db(1).diameter      = 12;

ops0.toolbox_path = 'C:\Users\Admin\Desktop\BigData\Marius Pachitariu\Suite2P-master';
...
ops0.RootStorage            = 'C:\Users\Admin\Desktop\BigData\Marius Pachitariu'; % Suite2P assumes a folder structure, check out README file
ops0.temp_tiff              = 'C:\Users\Admin\Desktop\BigData\Marius Pachitariu\temp.tif'; % copies each remote tiff locally first, into this file
ops0.RegFileRoot            = 'C:\Users\Admin\Desktop\BigData\Marius Pachitariu';  % location for binary file
ops0.DeleteBin              = 1; % set to 1 for batch processing on a limited hard drive
ops0.ResultsSavePath        = 'C:\Users\Admin\Desktop\BigData\Marius Pachitariu'; % a folder structure is created inside
