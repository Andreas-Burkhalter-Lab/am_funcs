...
% han lab screen dimensions = 1280x720
...
Axes = [0 0; 90 90]; %% diameter of [hrz vert] ellipse axes in degrees; (approximate for off-center stim)... 2 each in Gao... screen height ~92.5deg
Angle = [100; 20];
