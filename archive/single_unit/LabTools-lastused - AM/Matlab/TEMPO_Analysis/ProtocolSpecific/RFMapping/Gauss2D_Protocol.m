...
%%%%% AM note: this function does not write to output summary file
...
function Gauss2D_Protocol(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE, skip_trials)
    ...
    title(FILE);  % Add in a title JWN 072405.......... AM corrected capitalization 8/29/16
    ax1 = axis;
    colorbar
    axis image
