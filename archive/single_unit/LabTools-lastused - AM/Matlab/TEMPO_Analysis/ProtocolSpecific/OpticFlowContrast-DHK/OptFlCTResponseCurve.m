...
%--	GCD, 1/12/06
%-----------------------------------------------------------------------------------------------------------------------
function OptFlCTResponseCurve(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
if (output == 1)
    ...
    outfile = [BASE_PATH 'ProtocolSpecific\OpticFlowContrast-DHK\OpticFlowContrast_Summary.dat'];
    printflag = 0;
