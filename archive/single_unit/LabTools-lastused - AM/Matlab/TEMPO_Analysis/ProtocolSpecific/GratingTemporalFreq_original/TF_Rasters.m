...
function TF_Rasters(data, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, StartEventBin, StopEventBin, PATH, FILE, Protocol);
...
xlabel('Time (s)')
ylabel('Trial')
title('Optimized Temporal Frequency Spike Rasters')