...
null_resp = data.spike_rates(SpikeChan, null_trials & select trials);
...
yl = ylim;
ylim([0 y1(2)]); %set the lower limit of the Y axis to zero
...
y_fit = [ones(length(y_fit_raw), 1) y_fit_raw];
