...
%--	GCD, 1/26/00
%-----------------------------------------------------------------------------------------------------------------------
function LoomingGassianAmpTuningCurve(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
if (output == 1)
    ...
    outfile = [BASE_PATH 'ProtocolSpecific\LoomingGassianAmp-DHK\GassianAmp_Summary.dat'];
    printflag = 0;
