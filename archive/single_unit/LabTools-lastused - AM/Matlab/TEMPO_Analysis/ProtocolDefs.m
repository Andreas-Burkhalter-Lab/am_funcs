...
%----------------------------------------------------
% OpticFlow& Looming Protocols - DHK Summer Work 05/29/2012
%----------------------------------------------------
OPTIC_FLOW_RGBLUM = 29;
OPTIC_FLOW_SPEED = 30;
OPTIC_FLOW_GASSIAN_AMP = 31;
OPTIC_FLOW_COHER = 32;
OPTIC_FLOW_AZ = 33;
OPTIC_FLOW_EL = 34;
LOOMING_GAMP = 35;
LOOMING_SPEED = 36;
LOOMING_GASSIAN_AMP = 37;
...
% OpticFlow& Looming Protocols - DHK Summer Work 05/29/2012
protocol_names(30:38) = {
    'OPTIC FLOW RGBLUM',
    'OPTIC FLOW SPEED',
    'OPTIC FLOW GASSIAN_AMP',
    'OPTIC FLOW COHER',
    'OPTIC FLOW AZ',
    'OPTIC FLOW EL',
    'LOOMING GAMP',
...
% Added by DHK summer work
dots_keywords{num_keys}='DOTS_AP_ZCTR';         DOTS_AP_ZCTR=num_keys;           num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_AP_ZSIZ';         DOTS_AP_ZSIZ=num_keys;           num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_AP_AZI';          DOTS_AP_AZI=num_keys;            num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_AP_ELE';          DOTS_AP_ELE=num_keys;            num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_AP_VEL';          DOTS_AP_VEL=num_keys;            num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_AP_DIST';         DOTS_AP_DIST=num_keys;           num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_AP_SIGMA';        DOTS_AP_SIGMA=num_keys;          num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_AP_DUR';          DOTS_AP_DUR=num_keys;            num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_AP_XCTR';          DOTS_AP_XCTR=num_keys;            num_keys=num_keys+1;
...
%% -------------------------------------------------------------------------
% DHK Summer Work_ Optic Flow and Looming parameters + analysis  05/29/12

% added parameters
num_keys = 1;
dots_draw_keywords{num_keys}='DOTS_DRAW_MODE';	DOTS_DRAW_MODE=num_keys; 				num_keys=num_keys+1;

bgnd_keywords{num_keys}='BGND_RLUM';        BGND_RLUM=num_keys;         num_keys=num_keys+1;
bgnd_keywords{num_keys}='BGND_GLUM';        BGND_GLUM=num_keys; num_keys=num_keys+1;
bgnd_keywords{num_keys}='BGND_BLUM';        BGND_BLUM=num_keys; num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_RGBLUM';       DOTS_RGBLUM=num_keys; num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_DIREC';       DOTS_DIREC=num_keys; num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_VDISP';       DOTS_VDISP=num_keys; num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_BIN_CORR';       DOTS_BIN_CORR=num_keys; num_keys=num_keys+1;
dots_keywords{num_keys}='DOTS_HGRAD_MAG';       DOTS_HGRAD_MAG=num_keys; num_keys=num_keys+1;
...
enable_keywords{num_keys}='ENABLE_COLOR';         ENABLE_COLOR=num_keys; num_keys=num_keys+1;
eye_keywords{num_keys}='EYE_SELECTION';        EYE_SELECTION=num_keys; num_keys=num_keys+1;
enable_keywords{num_keys}='ENABLE_LOOMING_GRATING';       ENABLE_LOOMING_GRATING=num_keys; num_keys=num_keys+1;
stim_keywords{num_keys}='STIM_MOTION_TYPE';     STIM_MOTION_TYPE=num_keys; num_keys=num_keys+1;
looming_keywords{num_keys}='LOOMING_PMODE';        LOOMING_PMODE=num_keys; num_keys=num_keys+1;
looming_keywords{num_keys}='LOOMING_XCTR';         LOOMING_XCTR=num_keys;      num_keys=num_keys+1;
looming_keywords{num_keys}='LOOMING_YCTR';         LOOMING_YCTR=num_keys; num_keys=num_keys+1;
looming_keywords{num_keys}='LOOMING_ZCTR';         LOOMING_ZCTR=num_keys; num_keys=num_keys+1;
looming_keywords{num_keys}='LOOMING_OBJ_RADIUS';       LOOMING_OBJ_RADIUS=num_keys; num_keys=num_keys+1;

NUM_DOTS_PARAMS = num_keys - 1;
NUM_DOTS_DRAW_PARAMS = num_keys - 1;
NUM_DOTS_AP_PARAMS = num_keys - 1;
NUM_STIM_PARAMS = num_keys - 1;
NUM_BGND_PARAMS = num_keys - 1;
NUM_LOOMING_PARAMS = num_keys - 1;
NUM_EYE_PARAMS = num_keys - 1;
NUM_ENABLE_PARAMS = num_keys - 1;

% analysis types
analysis_strings{OPTIC_FLOW_RGBLUM + 1} = ...
    {	'Plot Tuning Curve',
    'Plot PSTH'
     'Plot Spike Rasters'
     'Pooling'};

analysis_strings{OPTIC_FLOW_SPEED +1} = ...
    {	'Plot Tuning Curve',
  'Plot Histograms' 
    'Plot Auto and Cross Correlograms'
    'Fit Gaussian'};

analysis_strings{OPTIC_FLOW_GASSIAN_AMP +1} = ...
    {	'Plot Tuning Curve',};

analysis_strings{OPTIC_FLOW_COHER +1} = ...
    {	'Plot Tuning Curve',
    'Plot PSTH'
    'Plot Spike Rasters'};

analysis_strings{OPTIC_FLOW_AZ +1} = ...
    {	'Plot Tuning Curve',};

analysis_strings{OPTIC_FLOW_EL +1} = ...
    {	'Plot Tuning Curve',};

analysis_strings{LOOMING_GAMP +1} = ...
    {	'Plot Tuning Curve',
    'Plot PSTH',
    'Plot Spike Rasters',
    'Pooling',};

analysis_strings{LOOMING_SPEED +1} = ...
    {	'Plot Tuning Curve',
    'Plot Histograms',
    'Plot Auto and Cross Correlograms',
    'Fit Gaussian'};

analysis_strings{LOOMING_GASSIAN_AMP +1} = ...
    {	'Plot Tuning Curve',};
%----------------------------------------------------------------------
