...
function LoomingContrastRasters(data, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, StartEventBin, StopEventBin, PATH, FILE, Protocol);
...
xlabel('Time (s)')
ylabel('Trial')
title('Optimized Grating Contrast Spike Rasters')