...
%--	GCD, 1/12/06
%-----------------------------------------------------------------------------------------------------------------------
function LoomingCTResponseCurve(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
if (output == 1)
    ...
    outfile = [BASE_PATH 'ProtocolSpecific\LoomingContrast-DHK\LoomingContrast_Summary.dat'];
    printflag = 0;
