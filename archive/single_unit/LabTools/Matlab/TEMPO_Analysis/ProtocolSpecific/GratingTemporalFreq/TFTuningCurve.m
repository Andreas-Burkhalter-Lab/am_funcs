...
%         plot_y=spike_rates(~null_trials(ind_laser0) & select_trials(ind_laser0) & grating_select(ind_laser0));
    ...
    axis([0 100 0 100]);
    axis('off');
    PrintTemporalFreqData2(p_value, base_rate, amplitude, peak, st_dev, log_offset, max_rate, stats1, stats2, chi2, chiP, TFDI, tf_width_halfmax);
