...
function OptFlContrastRasters(data, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, StartEventBin, StopEventBin, PATH, FILE, Protocol);
...
count=1;
figure(2);
set(gcf,'PaperPosition', [.51 .51 20 27.5], 'Position', [450 50 500 573], 'Name', 'Optimized Contrast Raster');
...
xlabel('Time (s)')
ylabel('Trial')
title('Optimized Optic Flow Contrast Spike Rasters')