...
%--	GCD, 1/26/00
%-----------------------------------------------------------------------------------------------------------------------
function SpeedTuningCurve_012007_bup(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
% PrintSpeedData(plot_x, plot_y, pmax, pmin, px, null_rate, pars, fit_err, p_value, avg_resp, stats1, stats2,SDI,chi2,chiP);
...
% matfileid = [BASE_PATH 'ProtocolSpecific\SpeedTuning\dprime_population_Gamma.mat'];
% 
...
% matfileid = [BASE_PATH 'ProtocolSpecific\SpeedTuning\Gammaderiv_population.mat'];
% 
% if exist(matfileid, 'file')
