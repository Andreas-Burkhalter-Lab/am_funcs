...
function OptFlSpeedTuningCurve(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
%     fclose(proffid);
    ...
    %%%%%% 3/14/16 AM updated summary file path below; was previously C:\LabTools\Matlab\TEMPO_Analysis\ProtocolSpecific\OpticFlowCoherence-DHK\OpticFlowCoherence_Summary.dat
