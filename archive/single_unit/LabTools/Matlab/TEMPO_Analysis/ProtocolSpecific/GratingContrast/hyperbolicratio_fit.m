...
%OPTIONS = OPTIMSET('fmincon'); JI comment out10/5/2015
%OPTIONS = OPTIMSET('LargeScale', 'off', 'LevenbergMarquardt', 'on',
%'MaxIter', 5000, 'Display', 'off');Ji comment our10/5/2015
%OPTIONS = OPTIMSET('LargeScale', 'off', 'LevenbergMarquardt', 'on', 'MaxIter', 5000);
OPTIONS = optimset('MaxIter', 5000);%JI inset this line 10/5/2015
N_reps = 40;
wiggle = 0.2;
testpars = []; err=[];
for j=1:N_reps
