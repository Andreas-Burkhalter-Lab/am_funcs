...
%--	GCD, 3/10/05
%-----------------------------------------------------------------------------------------------------------------------
function LoomingSpeedTuningCurveGaussian(data, Protocol, Analysis, SpikeChan, StartCode, StopCode, BegTrial, EndTrial, StartOffset, StopOffset, PATH, FILE);
...
if output == 1
    ...
    outfile = [BASE_PATH 'ProtocolSpecific\LoomingSpeed-DHK\LoomingSpeedTuningSummary_Gaussian.dat'];
    printflag = 0;
