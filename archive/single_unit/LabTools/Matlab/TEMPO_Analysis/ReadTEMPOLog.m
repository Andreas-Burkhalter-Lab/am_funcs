...
%----------------------------------------------------------------------------------------------------------
function [gratings_params, revcorr_params, dots_params, moog_params,...
    targ_params, cue_params, misc_params, one_time_params, eye_calib_params,...
    obj_params, bar_params, bkgnd_params, neuron_params, laser_values] = ReadTEMPOLog(logfile, num_trials);
...
if pooling == 0
    for i=1:num_lines_read
        ...
        % DHK 12/10/2015 - Enable Laser reading
        case 'ENABLE_LASER'
            laser_values(i) = sscanf(data{i}, '%f')+1;
...
% DHK 12/10/2015 - Enable Laser reading
laser_values(laser_values==0)=[];
laser_values=laser_values-1;
return;