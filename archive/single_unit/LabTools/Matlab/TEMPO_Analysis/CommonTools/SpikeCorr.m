...
if windowflag == 0
    ...
    correl_temp=0;
    for i=1:num_trials
        temp01 = spike_data1(1, :,i);
        temp02 = spike_data2(1, :, i);
        [correl0, lags0] = xcorr(temp01, temp02, 50);
        correl_temp = correl0+correl_temp;
    end
    hold on
    plot(lags0, correl_temp,'r')
    data.corr{1}=correl_total;
    data.corr{2}=correl_temp;
    %**********************************************************************   
