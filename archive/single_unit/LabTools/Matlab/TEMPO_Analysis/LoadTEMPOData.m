...
[gratings_params, revcorr_params, dots_params, moog_params, targ_params, cue_params, misc_params, one_time_params, eye_calib_params, obj_params, bar_params, bkgnd_params, neuron_params, laser_values] = ReadTEMPOLog(logfile, num_trials);
...
%% 12/21/2015 DHK - Laser Value Enable
good_data.laser_values=laser_values;
bad_data.laser_values=laser_values;
