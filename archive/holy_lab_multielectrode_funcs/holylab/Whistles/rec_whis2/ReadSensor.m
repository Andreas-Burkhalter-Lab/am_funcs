...
% start and stop time of each period in which the mouse is proximal to the
...
%     the optical detector 'hi'. [Correction: shouldn't this be 'lo' for
%     the optical detector too?] You must set this field.
