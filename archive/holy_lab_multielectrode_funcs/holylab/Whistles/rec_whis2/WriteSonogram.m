...
%
% This function writes the sonogram data to a file. The data may be processed in
% blocks. The format for each block of data is the length of the data, all of the
% column numbers associated with the data, all of the row numbers associated with the
% data, all of the real parts of the data (complex numbers), and all of the imaginary 
% parts of the data (complex numbers). The header must be written outside of this function.
%
% Syntax:
...
%    freqRange is a 2 element vector containing the minimum and maximum row numbers.
%      The data between the min and max row numbers is written to disk.
