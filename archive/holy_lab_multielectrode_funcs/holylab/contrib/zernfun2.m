function [z,m] = zernfun2(p,r,theta,nflag)
...
%
% [n,m] = zernfun2(p)
%   returns the conversion from one numbering scheme to the other.
%
%   See also ZERNPOL, ZERNFUN.

%   Paul Fricker 11/13/2006
% Tiny modifications by Tim Holy 11/27/2008 
...
switch nargin
  case 1
    z = n;  % Just return p->n,m conversion
  case 3
