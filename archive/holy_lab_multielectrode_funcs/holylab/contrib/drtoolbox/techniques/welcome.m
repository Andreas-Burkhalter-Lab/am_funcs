...
% Maastricht University, 2007
    ...
    if isempty(DR_WELCOME)
        disp(' ');
        disp('   Welcome to the Matlab Toolbox for Dimensionality Reduction, version 0.4b (12-January-2008).');
        disp('      You are free to modify or redistribute this code (for non-commercial purposes), as long as a reference');
        disp('      to the original author (Laurens van der Maaten, MICC, Maastricht University) is retained.');
