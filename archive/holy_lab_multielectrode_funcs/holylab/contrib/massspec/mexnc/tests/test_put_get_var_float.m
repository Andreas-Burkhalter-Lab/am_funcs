...
%     [PUT,GET]_VAR_FLOAT: Write a 6x4 array of monotonically increasing values, read them back.
...
status = mexnc ( 'PUT_VARA_FLOAT', ncid, varid, [1 0], [3 3], input_data' );
if ( status < 0 )
...
[output_data, status] = mexnc ( 'GET_VARA_FLOAT', ncid, varid, [1 0], [3 3] );
if ( status < 0 )
