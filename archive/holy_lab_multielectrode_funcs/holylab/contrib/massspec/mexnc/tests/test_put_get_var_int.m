...
status = mexnc ( 'PUT_VARA_INT', ncid, varid, [1 0], [3 3], input_data' );
if ( status < 0 )
...
[output_data, status] = mexnc ( 'GET_VARA_INT', ncid, varid, [1 0], [3 3] );
if ( status < 0 )
...
status = mexnc ( 'PUT_VARS_INT', ncid, varid, [0 0], [r c], [2 2], input_data' );
if ( status < 0 )
...
[output_data, status] = mexnc ( 'GET_VARS_INT', ncid, varid, [0 0], [r c], [2 2] );
if ( status < 0 )
