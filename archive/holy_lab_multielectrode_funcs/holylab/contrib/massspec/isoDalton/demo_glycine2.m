%--------------------------------------------------------------------------------------------------
%
% Filename:     	demo_glycine2.m
% Description:  	This demo plots the exact probability profile (within double precision) 
%                 of the 13 masses that are separated by near integer spacing of glycine  (figure 1)
