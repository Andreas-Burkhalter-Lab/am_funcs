function [ica_sig, ica_filters, ica_A, numiter, icskew] = CellsortICA(mixedsig, ...
...
%   nIC (default N) - number of ICs to derive
%   ica_A_guess (default random) - initial guess for unmixing matrix
%   termtol (default 1e-6) - termination tolerance; fractional change in
%     output at which to end iteration of the fixed point algorithm.
%   maxrounds (default 100) - maximum number of rounds of iterations
%
% Outputs:
