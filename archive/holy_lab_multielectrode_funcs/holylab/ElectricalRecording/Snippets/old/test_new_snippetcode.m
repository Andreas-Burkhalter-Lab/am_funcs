...
% [tsnip,snip] = snippetfile('wave10.bin',scanrange,channels,thresh,sniprange,struct('interptimes',1,'interpsnips',1));
fid=fopen('wave10.bin');
snippetfile(fid, scanrange,channels,thresh,sniprange,struct('interptimes',1,'interpsnips',1), 'wave10.snip');
