...
%
% See also FINDST_TIME MEEA_MAXSUM MEEA_RESAMPLE MULTI_ELECTRODE_EPHYS_ANALYZE  
...
%% calculate tstart using findst_time(H Arnson)
% ** this fxn is not very flexible, only works for default trange [-10 30]
% ** to improve, adopt the idea and add flexibility for different t ranges
...
%% Legacy code (replaces findst_time section)
% %% Check for variables
% analysis_out = analysis_in;
% 
