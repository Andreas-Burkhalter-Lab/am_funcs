function [intervals] = intervalsContTimes(...
  cellNumber,cellSortFile,chanfile,files,data);
...
for nthFile = 1:nFiles
  ...
  starts = sort(starts)+offsetInScans(nthFile);
  stops = sort(stops)+offsetInScans(nthFile);
