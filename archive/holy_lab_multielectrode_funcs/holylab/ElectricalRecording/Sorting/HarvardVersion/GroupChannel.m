function [tout,indexout] = GroupChannel(spikefiles,channel,filters,subrange,blocksize,useclnums,snipindx,options)
...
if (subset)
        ...
        [chans,mnsnips] = GetSnipNums(spikefiles,options);
...
while (outrange == 0)
        ...
        [snips,f,t,header] = LoadIndexSnippetsMF(spikefiles,channel,blkindx,options);
