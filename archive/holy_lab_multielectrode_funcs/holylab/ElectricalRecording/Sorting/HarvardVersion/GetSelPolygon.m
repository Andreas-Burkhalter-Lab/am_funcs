...
% the user clicks to set the vertex. A double click or shift-click closes
% the polygon and returns the coordinates of the vertices.
...
case 'continuing'
        ...
        if (~isempty(strmatch(selection_type,{'extend','alternate','open'})))
                hline = findobj(gcbf,'Tag','GSPline');
                set(hax,'ButtonDownFcn',get(hline,'UserData'));        % Restore original
