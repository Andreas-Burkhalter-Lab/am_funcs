function cass_sort_apply(dirname,options)
...
% Copyright 2005 by Timothy E. Holy
  ...
  tfilecontents = load([pwd filesep dirname filesep 'overview']);
  ...
  for i = 1:length(channels)
    ...
    dirchan = ['./' dirname filesep 'chan' num2str(currentChannel) filesep];
    if isfield(options,'chanfile')
