function [g,psig,sqrtdetJ,err,params] = register_multigrid_smgrad(g,psiM_0,lambda,warp_options,params)
  [psig,w,sqrtdetJ] = register_warp(psiM_0,g,warp_options);
  dimKeep = params.pixel_spacing > 0;

  % DC components: do a rigid translation so that fit is optimized
