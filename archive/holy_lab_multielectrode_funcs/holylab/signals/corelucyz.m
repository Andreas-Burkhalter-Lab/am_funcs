function f = corelucyz(Y,H,DAMPAR22,wI,READOUT,SUBSMPL,idx,vec,num)
%corelucyz Accelerated Damped Lucy-Richarson Operator.
...
%
% See also DECONVLUCYZ and DECONVBLIND.
...
ReBlurred = real(ifft(bsxfun(@times,H,fft(Y,[],3)),[],3));
