function hh = errorbarlog(x, y, l,u,symbol)
%ERRORBARLOG Error bar plot for logarithmic axes.
%   ERRORBARLOG(X,Y,L,U) plots the graph of vector X vs. vector Y with
...
%
%   ERRORBARLOG(X,Y,E) or ERRORBARLOG(Y,E) plots Y with error bars [Y-E Y+E].
%   ERRORBARLOG(...,'LineSpec') uses the color and linestyle specified by
%   the string 'LineSpec'.  See PLOT for possibilities.
%
%   H = ERRORBARLOG(...) returns a vector of line handles.
%
%   For example,
%      x = 1:10;
%      y = sin(x);
