...
% @jason: solve the problem when dir doesn't ends w/ / and user click filelist
if(any(strcmp(who, 'Data')))
   ttCurDir=Data.CurrentDir;
   if(ttCurDir(end)~=filesep) ttCurDir=[ttCurDir filesep]; end
   Data.CurrentDir=ttCurDir;
end
