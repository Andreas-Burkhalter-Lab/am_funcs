function WriteAIHeaderHarvard(fid,header)
% WriteAIHeaderHarvard: Write the header for raw waveform files (AI = analog input)
% WriteAIHeaderHarvard(fid,header)
% Writes version 2 headers
